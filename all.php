<?php
include 'api.php';
$url = "https://api.rawg.io/api/games?key=" . $apiKey . "&page_size=80&ordering=-added";
...
<body>
    <div class="container">
        ...
        <div class="main-cont">
            <div class="content">
                <h1 style="color:white; margin-bottom:20px; font-family:sans-serif;">All games</h1>
                <div class="game-box" id="games-grid">
                    <?php if (empty($speles)): ?>
