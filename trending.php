<?php
include 'api.php';
$url = "https://api.rawg.io/api/games?key=" . $apiKey . "&dates=2024-01-01,2026-12-31&ordering=-added&page_size=24";
...
<head>
    ...
    <title>GameVault - Trending Games</title>
    ...
    <div class="container">
        ...
        <div class="main-cont">
            <div class="content" style="display:flex; flex-direction:column; align-items:center;">
                <h1 style="color:white; margin-bottom:20px; font-family:sans-serif;">Trending Games</h1>
                <div class="game-box" id="trending-grid">
                    <?php if (empty($speles)): ?>
                        <p style="color:white; padding:20px;">Couldnt load the games.</p>
                    <?php else: ?>
